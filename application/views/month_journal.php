            ...
            <div class="animated fadeIn">
                    ...
                    <div class="card">
                                        ...
                                        <select type="text" class="form-control" name="periode">
                                            <?php
                                                ...
                                                for($i=0;$i<24;$i++){
                                                    ...
                                                    $no_periode = $this->input->post('periode');

                                                ?>
                                                <option value="<?php echo sprintf('%02d', $i+1).$date2; ?>" <?php if(sprintf('%02d', $i+1).$date2 == $no_periode) echo 'selected = "selected"'; ?>> Periode <?php echo sprintf('%02d', $i+1); ?>&nbsp;&nbsp;&nbsp;<?php echo $date; ?></option>
                                            <?php }
                                        } 
                                        ?>
                                        </select>
                                        <button type="submit" name="cari_month_journal" class="col-md-12 btn btn-primary" style="margin:10px 0 30px 0"><i class="fa fa-search"></i>&nbsp Lihat jurnal</button>
                                    </div>
                                </div>
                        </div>
                        ...
                        <tbody id="t">
                           ...
                           <tr class="blank-row">
                            <td><?php echo substr($this->input->post('periode'), 0, 2); ?></td>
                            <td><?php 
                            ...
                            <td align="center"><a href="" onclick="window.open('<?php echo base_url()."journal_detail/$list->id_perusahaan/$list->id_inputan" ?>', 'newwindow'); return false;" class="btn-sm btn-primary">Detail</a></td>
                          </tr>
                        <?php } ?>
                        </tbody>
                        </table> 
                                <?php } else{ ?>
                                        <select type="text" class="form-control" name="periode">
                                            <?php
                                                ...
                                                ?>
                                                <option value="<?php echo sprintf('%02d', $i+1).$date2; ?>"> Periode <?php echo sprintf('%02d', $i+1); ?>&nbsp;&nbsp;&nbsp;<?php echo $date; ?></option>
                                            <?php }
                                        } 
                                        ?>
                                        </select>
