...
<div id="right-panel" class="right-panel">
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1 style="font-size: 20px">Pengelolaan Perusahaan</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
            ...
            <div class="animated fadeIn">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5>Tambah Pengelola Perusahaan</h5>
                        </div>
                      ...
                      <div class="modal-content">
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                <select type="text" class="form-control" name="id_perusahaan">
                                    <?php
                                        foreach($detail_perusahaan->result() as $list){
                                    ?>
                                    <option value="<?php echo $list->id_perusahaan; ?>">
                                        <?php echo $list->nama_perusahaan; ?></option>
                                    <?php } ?>
                                </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                <select type="text" class="form-control" name="username">
                                    <?php
                                        foreach($detail2->result() as $list){
                                    ?>
                        ...
                        <div class="modal-footer">
                          <button type="submit" class="btn btn-info" name="insert_pengelolaan">Submit</button>
                        </div>
                      </div>
                    </form>
                        </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5>Daftar Pengelolaan Perusahaan</h5>
                        </div>
                    ...
                    <thead>
                      <tr>
                        <th>Username</th>
                        <th>Nama Perusahaan yang dikelola</th>
                        <th>Opsi</th>
                      </tr>
                    </thead>
                    <tbody>
                    <?php foreach ($listpengelolaan->result() as $list) { ?>   
                    <tr>
                      <td><?php echo $list->username ?></td>
                      <td><?php echo $list->nama_perusahaan ?></td>
                      <td><center><a onclick="return confirm('Ingin Menghapus Pengelolaan?');" href="<?php echo base_url()."hapus_pengelolaan/".$list->id_pengelolaan; ?>" class="btn btn-danger"><i class="fa fa-trash"></i>
                    <span>Hapus</span></a></center></td>
                    </tr>
                   <?php } ?>
                    </tbody>
                    </table>
 ...
 <!-- modal -->
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <?php }elseif($this->session->flashdata('result_insert_pengelolaan')){ ?>
            ...
            <?php }elseif($this->session->flashdata('failed_insert_pengelolaan')){ ?>
                <script>
                    $(window).load(function(){
                        swal({
                            title: "Warning",
                            text: "Data pengelolaan sudah tersedia",
                            type: "warning",
                            confirmButtonColor: '#DD6B55',
                            confirmButtonText: 'Ok!',
                            closeOnConfirm: false,
